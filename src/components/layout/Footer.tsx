        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/about" className="text-gray-300 hover:text-morocco-amber transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-300 hover:text-morocco-amber transition-colors">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link to="/artisans" className="text-gray-300 hover:text-morocco-amber transition-colors">
                  Meet Our Artisans
                </Link>
              </li>
              <li>
                <Link to="/blog" className="text-gray-300 hover:text-morocco-amber transition-colors">
                  Blog
                </Link>
              </li>
              <li>
                <Link to="/faq" className="text-gray-300 hover:text-morocco-amber transition-colors">
                  FAQs
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/shipping" className="text-gray-300 hover:text-morocco-amber transition-colors">
                  Shipping Policy
                </Link>
              </li>
              <li>
                <Link to="/returns" className="text-gray-300 hover:text-morocco-amber transition-colors">
                  Returns & Exchanges
                </Link>
              </li>
              <li>
                <Link to="/terms" className="text-gray-300 hover:text-morocco-amber transition-colors">
                  Terms & Conditions
                </Link>
              </li>
              <li>
                <Link to="/privacy" className="text-gray-300 hover:text-morocco-amber transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link to="/track-order" className="text-gray-300 hover:text-morocco-amber transition-colors">
                  Track Your Order
                </Link>
              </li>
            </ul>
