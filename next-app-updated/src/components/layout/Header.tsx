      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link 
              href="/cart" 
              className="text-gray-500 hover:text-amber-600 p-2 relative"
            >
              <ShoppingCart className="h-6 w-6" />
              <span className="absolute top-0 right-0 bg-amber-600 text-white rounded-full h-5 w-5 flex items-center justify-center text-xs">
                0
              </span>
            </Link>
