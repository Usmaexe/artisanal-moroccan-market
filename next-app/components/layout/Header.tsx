  ...
  return (
    <header className="bg-morocco-cream shadow-sm">
      ...
      <div className="hidden sm:flex justify-between items-center px-4 py-2 bg-morocco-terracotta text-white text-sm">
        ...
        <div className="flex gap-4">
          <select title="language" className="bg-transparent border-none outline-none cursor-pointer">
          ...
          <span>|</span>
          <select title="currency" className="bg-transparent border-none outline-none cursor-pointer">
      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex flex-1 justify-center space-x-6">
          <Link href="/" className="font-medium hover:text-morocco-terracotta">Home</Link>
          ...
          <Link href="/artisans" className="font-medium hover:text-morocco-terracotta">Artisans</Link>
          <Link href="/about" className="font-medium hover:text-morocco-terracotta">Our Story</Link>
          <Link href="/contact" className="font-medium hover:text-morocco-terracotta">Contact</Link>
        </nav>
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link href="/wishlist" className="text-morocco-charcoal hover:text-morocco-terracotta transition-colors">
            <Heart size={20} />
          </Link>
          <Link 
            href="/cart" 
