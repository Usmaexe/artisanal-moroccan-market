...
export default function ContactPage() {
  return (
    <div className="bg-amber-50 min-h-screen py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">        {/* Header */}
        <div className="mb-12 text-center">
          <h1 className="text-4xl font-bold text-amber-800 mb-4">Contact Us</h1>
          <p className="max-w-2xl mx-auto text-amber-600 text-lg">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div>
              <div className="bg-white rounded-xl shadow-lg overflow-hidden">                <div className="p-8">
                  ...
                  <form className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">                      <div>
                        ...
                        <input
                          ...
                          id="name"
                          name="name"
                          className="w-full px-4 py-2 border text-amber-950 border-gray-300 rounded-md shadow-sm focus:ring-amber-500 focus:border-amber-500"
            ...
            <div className="space-y-8">
              {/* Map Placeholder */}
              <div className="h-[250px] bg-amber-100 rounded-xl overflow-hidden relative flex items-center justify-center">                <div className="text-center px-4">
              ...
              {/* Contact Information */}              <div className="bg-white rounded-xl shadow-lg p-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="flex-shrink-0">
                      ...
                      <h3 className="text-lg font-medium text-amber-800">Our Location</h3>
                  ...
                  <div className="flex items-start">
                    <div className="flex-shrink-0">
                      ...
                      <h3 className="text-lg font-medium text-amber-800">Email Us</h3>
                      <p className="mt-1 text-amber-600">
                  ...
                  <div className="flex items-start">
                    <div className="flex-shrink-0">
                      ...
                      <h3 className="text-lg font-medium text-amber-800">Call Us</h3>
                      <p className="mt-1 text-amber-600">
                        <a href="tel:+212535123456" className="hover:text-amber-700">
                          +212 535 123 456
                        </a>
                      </p>
                    </div>
                ...
                {/* Social Media */}                <div className="mt-8 pt-6 border-t border-gray-200">
                  <h3 className="text-lg font-medium text-amber-800 mb-4">Follow Us</h3>
                  <div className="flex space-x-4">
                    <a href="#" className="bg-amber-100 p-3 rounded-full text-amber-600 hover:bg-amber-200" title="Follow us on Instagram">
                      <Instagram className="h-5 w-5" />
                    </a>
                    <a href="#" className="bg-amber-100 p-3 rounded-full text-amber-600 hover:bg-amber-200" title="Follow us on Facebook">
                      <Facebook className="h-5 w-5" />
                    </a>
                    <a href="#" className="bg-amber-100 p-3 rounded-full text-amber-600 hover:bg-amber-200" title="Follow us on Twitter">
          ...
          {/* FAQ Section */}
          <div className="mt-16">            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold text-amber-800">Frequently Asked Questions</h2>
              <p className="mt-2 text-amber-600">Have questions? Check out our frequently asked questions</p>
            </div>

            <div className="grid md:grid-cols-2 gap-6">              <div className="bg-white rounded-lg shadow p-6">
                <h3 className="text-lg font-medium text-amber-800 mb-2">How long does shipping take?</h3>
                <p className="text-amber-600">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <h3 className="text-lg font-medium text-amber-800 mb-2">Do you offer returns?</h3>
                <p className="text-amber-600">
                  Yes, we offer returns within 30 days of purchase. Items must be unused and in original packaging.
                </p>
              </div>
              <div className="bg-white rounded-lg shadow p-6">
                <h3 className="text-lg font-medium text-amber-800 mb-2">Are your products handmade?</h3>
                <p className="text-amber-600">
                  Yes, all our products are authentically handmade by skilled Moroccan artisans using traditional techniques.
                </p>
              </div>
              <div className="bg-white rounded-lg shadow p-6">
                <h3 className="text-lg font-medium text-amber-800 mb-2">Do you ship internationally?</h3>
                <p className="text-amber-600">
