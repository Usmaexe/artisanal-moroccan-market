        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">            <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {statistics.map((stat, index) => (                <div key={index} className="bg-white rounded-lg shadow-md p-6">
                  <p className="text-sm font-medium text-amber-600">{stat.label}</p>
                  <p className="text-2xl font-bold text-amber-800 mt-2">{stat.value}</p>
                </div>
              ))}
            ...
            <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="flex justify-between items-center p-3 bg-amber-50 rounded-md">
                      <div className="flex items-center">
                        <div className="w-10 h-10 rounded-full bg-amber-200 flex items-center justify-center mr-3">
                          ...
                          <p className="text-xs text-amber-600">customer</p>
                        </div>
                      </div>
                    ...
                    <div className="flex justify-between items-center p-3 bg-amber-50 rounded-md">
                      <div className="flex items-center">
                        <div className="w-10 h-10 rounded-full bg-amber-200 flex items-center justify-center mr-3">
                          ...
                          <p className="font-medium text-amber-800">Sarah Lee</p>
                          <p className="text-xs text-amber-600">artisan</p>
                        </div>
                      </div>
              ...
              <div>
                <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center p-3 bg-amber-50 rounded-md">                      <div>
                        <p className="font-medium text-amber-800">#ORD-2023-1568</p>
                        <p className="text-xs text-amber-600">April 15, 2023</p>
                      </div>
                      <span className="text-xs bg-yellow-100 text-yellow-800 px-2 py-1 rounded">Pending</span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-amber-50 rounded-md">                      <div>
                        <p className="font-medium text-amber-800">#ORD-2023-1567</p>
                        <p className="text-xs text-amber-600">April 14, 2023</p>
                      </div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center p-3 bg-amber-50 rounded-md">
                      <div className="w-12 h-12 bg-gray-200 rounded mr-3"></div>                      <div className="flex-1">
                        <p className="font-medium text-amber-800">Handmade Ceramic Tajine</p>
                        <div className="flex justify-between">
                          <p className="text-xs text-amber-600">54 sales</p>
                          <p className="text-sm font-medium text-amber-800">$89.99</p>
                        </div>
                      </div>
                    </div>
                    <div className="flex items-center p-3 bg-amber-50 rounded-md">
                      <div className="w-12 h-12 bg-gray-200 rounded mr-3"></div>                      <div className="flex-1">
                        ...
                        <div className="flex justify-between">
                          <p className="text-xs text-amber-600">42 sales</p>
                          <p className="text-sm font-medium text-amber-800">$129.99</p>
                        </div>
                      </div>
                    </div>
                  </div>
