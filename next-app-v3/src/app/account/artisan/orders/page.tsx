...
export default function ArtisanOrders() {
  ...
  // We're simulating orders that contain the artisan's products
  const orders = [
    {
      id: "ORD-2023-1568",
      customer: "John Doe",
      ...
      items: 2,
      payment: "Credit Card",
      products: [artisanProducts[0].id, artisanProducts[1].id]
    },
    {
      id: "ORD-2023-1567",
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
              <div>
                ...
                <p className="text-gray-600 mt-2">View orders containing your products</p>
              </div>
            </div>
                        ...
                        <tr key={order.id} className="hover:bg-amber-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div className="flex justify-end space-x-3">
                              <Link 
                                href={`/account/artisan/orders/${order.id}`}
