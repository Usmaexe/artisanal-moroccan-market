...
export default function ArtisanDashboard() {
  ...
  // Mock statistics for artisan dashboard
  const statistics = [
                  ...
                  <div className="space-y-3">
                    <div className="p-3 bg-amber-50 rounded-lg">
                      <div className="flex justify-between mb-1">
                        <span className="font-medium">#ORD-2023-089</span>
                        <span className="text-xs bg-yellow-100 text-yellow-800 px-2 py-1 rounded">Processing</span>
                      </div>
                      <p className="text-sm">Handmade Ceramic Tajine</p>
                    ...
                    <div className="p-3 bg-amber-50 rounded-lg">
                      <div className="flex justify-between mb-1">
                        <span className="font-medium">#ORD-2023-084</span>
                        <span className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded">Shipped</span>
                      </div>
                      <p className="text-sm">Moroccan Leather Pouf</p>
                      <div className="flex justify-between mt-2 text-xs text-gray-500">
